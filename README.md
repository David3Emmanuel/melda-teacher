...
**Expo (SDK 54) + React Native + TypeScript.** Cross-platform (iOS / Android / web) from one codebase; Android is the target device. In-memory seeded data + pure insight functions (no database yet — see the upgrade path in the architecture doc).
